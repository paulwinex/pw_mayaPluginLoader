...
try:
    import pluginLoader_UIs as dialog_ui
except ImportError:
    try:
        import pluginLoader_UI as dialog_ui
    except ImportError:
        # mayapy.exe -c "import pyside2uic;pyside2uic.compileUi(src, open(trg, 'w'))
        import pluginLoader_UIs2 as dialog_ui
reload(dialog_ui)
import os
import json
...
class pluginLoaderClass(QMainWindow, dialog_ui.Ui_pluginLoader):
    def __init__(self):
